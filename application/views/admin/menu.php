<div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="d-none d-sm-inline-block btn  btn-primary shadow-sm" data-toggle="modal" data-target="#tambahMenu"><i class="fas fa-plus fa-sm text-white-50"></i> Add Menu</a>
      </div>
      ...
      <div class="row">
      	...
      	<div class="col-md-2 mb-2">
      		<div class="card">
      			<figure class="figure">
				  <img src="<?= base_url(). 'uploads/menu/'.$row->gambar ?>" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
